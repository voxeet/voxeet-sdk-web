...
export interface RemoteVideo {
     ...
     *
     * The method requires a few seconds to become effective and is not available for [RTS listeners](./enums/models_Options.ListenType.html#Mixed). Calling this method by an RTS listener triggers the [UnsupportedError](./lib_Exceptions.UnsupportedError.html).
     *
     * @example
     * ```js
